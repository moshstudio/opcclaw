      ...
      <div className="space-y-4">
        <div className="space-y-1.5">
          ...
          <Input
            ...
            className="h-9 bg-muted/20 border-border/40 rounded-xl text-xs font-bold transition-all focus:bg-background"
          />
        </div>
        ...
        <div className="space-y-1.5">
          ...
          <Textarea
            ...
            className="min-h-[140px] bg-muted/20 border-border/40 rounded-xl p-3 text-xs leading-relaxed resize-none transition-all focus:bg-background"
          />
        </div>
