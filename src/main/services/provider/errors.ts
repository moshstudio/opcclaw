 ...
 */
export type FailoverReason = 'rate_limit' | 'auth' | 'timeout' | 'billing' | 'format' | 'unknown'
...
const TIMEOUT_PATTERNS = ['timeout', 'timed out', 'deadline exceeded', 'context deadline exceeded']
